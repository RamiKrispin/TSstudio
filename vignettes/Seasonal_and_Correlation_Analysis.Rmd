...
Generally, as the frequency of the series is more granular (hence, the data was captured in higher frequency such as seconds, minutes, etc.), potentially the data would have different seasonality  (or multi-seasonality) patterns. This function supports only time series objects with a "Date" or "POSIX" object as an index such as "xts", "zoo" and data frame family ("data.frame", "data.table", and "tbl") with a half-hourly, hourly, daily, monthly and quarterly frequencies. 
