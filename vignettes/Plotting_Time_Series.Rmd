...
The ts_plot is a versatile function for plotting time series objects. It is based on the plotly engine and supports multiple time series objects such as "ts", "mts", "zoo", "xts" and as well the data frame family ("data.frame", "data.table", and "tbl").
